require_relative "db_api_beta"

males = DbApiBeta.select_students_where_gender "==", "male"
first_name_an = DbApiBeta.select_students_where_first_name "=~", /an/i
less_than_190 = DbApiBeta.select_students_where_pounds "<", 190
from_TX = DbApiBeta.select_students_where_state "==", "TX"
